...
class Matrix:
    ...
    def __init__(
        ...
        *,
        ...
        if (
        ...
        elif "Curiosity" in os.uname().machine:
            addr_pins = [board.D0, board.D1, board.D2]
            if panel_height > 16:
                addr_pins.append(board.D3)
            rgb_pins = [
            board.A0,   # R1 - PB04
            board.A1,   # G1 - PB05
            board.A2,   # B1 - PB06
            ...
            clock_pin = board.D8    # PB00
            latch_pin = board.D9    # PB01
            oe_pin = board.D13      # PB23
